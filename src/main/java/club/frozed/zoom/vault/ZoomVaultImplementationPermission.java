package club.frozed.zoom.vault;

/**
 * Created by Ryzeon
 * Project: Zoom-Vault
 * Date: 1/10/2020 @ 22:08
 */

import club.frozed.core.manager.player.PlayerData;
import club.frozed.core.manager.player.grants.Grant;
import club.frozed.core.manager.ranks.Rank;
import club.frozed.zoom.ZoomVaultImplementation;
import club.frozed.zoom.utils.CC;
...
public class ZoomVaultImplementationPermission extends Permission {
    ...
    public void register() {
        Bukkit.getServer().getServicesManager().register(Permission.class, this , ZoomVaultImplementation.getInstance(), ServicePriority.Highest);
